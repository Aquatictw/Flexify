...
set_index and set_indices count every set for that exercise in CURRENT_STATE, including performed main-work sets. If the user reduces a named work group such as BBB to N sets, preserve the main work and remove only enough sets from that named group to leave N of those sets.
